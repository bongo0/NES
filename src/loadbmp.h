...
// Disable Microsoft Visual C++ compiler security warnings for fopen, strcpy,
// etc being unsafe
...
LOADBMP_API unsigned int loadbmp_encode_file(const char *filename,
  ...
  const unsigned int size =
      54 + width * height * 3; // 3 as the BMP format uses 3 channels (red,
                               // green, blue and NO alpha)
